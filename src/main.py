...
def main(page: ft.Page):
    ...
    cat_dropdown = ft.Dropdown(options=[ft.dropdown.Option("Escolar"), ft.dropdown.Option("Esportivo"), ft.dropdown.Option("Beach"), ft.dropdown.Option(
        "Combat")], value="Escolar", width=150, text_style=dropdown_style, bgcolor=COR_FUNDO_BRANCO, border_color=COR_TEXTO_ESCURO)
    gen_dropdown = ft.Dropdown(options=[ft.dropdown.Option("Feminino"), ft.dropdown.Option(
        "Masculino")], value="Feminino", width=150, text_style=dropdown_style, bgcolor=COR_FUNDO_BRANCO, border_color=COR_TEXTO_ESCURO)
    weight_input = ft.TextField(value="52", width=80, text_style=dropdown_style,
                                bgcolor=COR_FUNDO_BRANCO, border_color=COR_TEXTO_ESCURO)

    # Referências Visuais dos Atletas
    red_name = ft.TextField(bgcolor=COR_FUNDO_BRANCO, color=COR_TEXTO_ESCURO, height=40,
                            expand=True, content_padding=5, text_style=ft.TextStyle(font_family="Open Sans"))
    red_gym = ft.TextField(bgcolor=COR_FUNDO_BRANCO, color=COR_TEXTO_ESCURO, height=40,
                           expand=True, content_padding=5, text_style=ft.TextStyle(font_family="Open Sans"))
    blue_name = ft.TextField(bgcolor=COR_FUNDO_BRANCO, color=COR_TEXTO_ESCURO, height=40,
                             expand=True, content_padding=5, text_style=ft.TextStyle(font_family="Open Sans"))
    blue_gym = ft.TextField(bgcolor=COR_FUNDO_BRANCO, color=COR_TEXTO_ESCURO, height=40,
                            expand=True, content_padding=5, text_style=ft.TextStyle(font_family="Open Sans"))
    ...
    winner_display = ft.TextField(value="", text_align=ft.TextAlign.CENTER, text_size=20, text_style=ft.TextStyle(
        font_family="Montserrat", weight=ft.FontWeight.BOLD), bgcolor=COR_FUNDO_BRANCO, width=220, height=40, border_color=COR_TEXTO_ESCURO)
    arrow_display = ft.TextField(value="", text_align=ft.TextAlign.CENTER, text_size=20, text_style=ft.TextStyle(
        font_family="Montserrat", weight=ft.FontWeight.BOLD), bgcolor=COR_FUNDO_BRANCO, width=220, height=40, border_color=COR_TEXTO_ESCURO)
    ...
    def finish_match(e=None):
        ...
        if gerar_relatorio_flag.value:
            ...
            page.snack_bar = ft.SnackBar(ft.Text(
                mensagem, color=COR_FUNDO_BRANCO, font_family="Open Sans"), bgcolor=COR_VERDE_CBSA)
        else:
            page.snack_bar = ft.SnackBar(ft.Text("Luta finalizada (Relatório NÃO foi gerado).",
                                         color=COR_FUNDO_BRANCO, font_family="Open Sans"), bgcolor=COR_TEXTO_ESCURO)
    ...
    menu = ft.Container(
        ...
        content=ft.Row([
            ...
            ft.Row([ft.TextButton("Informar", style=ft.ButtonStyle(color=COR_FUNDO_BRANCO)), ft.TextButton(
                "Sair do Programa", style=ft.ButtonStyle(color=COR_FUNDO_BRANCO), on_click=lambda _: page.window.destroy())])
    ...
    header = ft.Column([
        ft.Row([
            ...
            ft.Container(width=20), ft.Image(
                src="cob.jpg", height=90, fit=ft.ImageFit.CONTAIN),
        ], alignment=ft.MainAxisAlignment.SPACE_BETWEEN),
        ...
        ft.Row([
            ...
            ft.Text("Peso:", color=COR_TEXTO_ESCURO, size=20, font_family="Montserrat", weight=ft.FontWeight.BOLD), weight_input, ft.Text(
                "Kg", color=COR_TEXTO_ESCURO, size=20, font_family="Montserrat", weight=ft.FontWeight.BOLD),
    ...
    # NOVO: Instanciação isolada do Relógio
    timer_panel = build_timer_display(
        timer_input=timer_input,
        start_cb=start_timer,
        pause_cb=pause_timer,
        finish_cb=finish_match
    )

    # A coluna central agora apenas empilha o relógio componentizado e os textos de resultado
    ...
    page.add(menu, ft.Container(height=5), header, ft.Container(height=10), ft.Row(
        [red_panel, center_col, blue_panel], expand=True, alignment=ft.MainAxisAlignment.SPACE_BETWEEN))
